                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i>Upcoming Marriage Anniversary</div>
                          <div class="muted pull-right">
								Upcoming Marriage Anniversary <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
