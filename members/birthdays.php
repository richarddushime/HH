                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i>Current and Upcoming Birthdays</div>
                          <div class="muted pull-right">
								Current and upcoming Birthdays <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
