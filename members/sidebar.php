                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
					  ...
					  <!------/.* manage System user sidebar*------->	
						...
						<li>						
						    ...
						    <li class="">
                            <a href="upcoming.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i> Marriage Anniversary </a>
                            </li>
						    
                <li class="">
                            <a href="birthdays.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i> Current Birthday </a>
                            </li>
						    </ul>
						</li>
					  ...
					  <!------/.* notification sidebar*------->
					   <li class="active">
                           <a href=" mailto:churchmanagementis@gmail.com"; role="button" data-toggle="collapse" data-target="#bs4"><i class="icon-chevron-right"></i></i>Contact CMIS
</a>  
                        </li>
